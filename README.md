...
This is Cuong Pham CK

Please note that `rememberizer-mcp-cuong-pham-ck` is currently in development and the functionality may be subject to change.
...
If you have SkyDeck AI Helper app installed, you can search for "Rememberizer" and install the rememberizer-mcp-cuong-pham-ck.
...
"mcpServers": {
  "rememberizer": {
      "command": "uvx",
      "args": ["rememberizer-mcp-cuong-pham-ck"]
    },
}
```
